...
# RAG Parameters
CHUNK_SIZE = 2500  # Target size (between 1500-3000)
CHUNK_OVERLAP = 200
TOP_K_CHUNKS = 5
...
def render_simplified_intro():
    ...
    <div class="info-box">
        ...
        <p style="margin-top:15px; font-style:italic; font-size: 0.9em; color: #555;">
            <strong>Ask about:</strong> Clinical syndromes, first-choice treatments, dosages, and alternatives.
        </p>
    </div>
    """, unsafe_allow_html=True)
...
def main():
    ...
    # -- Load Knowledge Base --
    # We use a spinner only on first load
    ...
    with st.sidebar:
        ...
        st.info(f"RAG Active\n\nChunks: ~{CHUNK_SIZE} chars\nOverlap: {CHUNK_OVERLAP}\nTop K: {TOP_K_CHUNKS}")
        st.divider()
